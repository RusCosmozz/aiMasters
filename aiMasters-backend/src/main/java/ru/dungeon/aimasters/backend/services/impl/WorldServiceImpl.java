...
public class WorldServiceImpl implements WorldService {
  ...
  @Override
  @Transactional
  public WorldResponseDto createWorld(WorldRequestDto worldRequestDto) {
    //todo отправить запрос на генерацию мира по входным параметрам в gpt api
    //todo сохранить сгенерированный мир
